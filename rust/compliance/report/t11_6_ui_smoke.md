...
| Logged model detail | `#/experiments/1/models/m-ab0ff9375eaa464da9e9a3c14f069ebd` | The finalized model detail rendered its ID, name, status, and parameters. Zero Python-attributed responses and no unexpected failed same-origin response. | **PASS** | `part1-logged-model-detail.png` | Populated finalized state. |
| Datasets dropdown + records | `#/experiments/1/datasets/d-1f22549b09aa4536ba628a3807947cba` | The experiment Datasets navigation and populated dataset records rendered. Zero Python-attributed responses and no unexpected failed same-origin response. | **PASS** | `dataset-records.png` | Shared with the T22.5 test; intentionally not duplicated. |
