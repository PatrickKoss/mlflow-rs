...
`// WEBHOOK SEAM:` markers at every registry trigger site for it. T2.2 (CI
dialect matrix) completed 2026-07-17. Phase 9+ (auth/RBAC, workspaces,
deployment, compliance) not started, pending review.
